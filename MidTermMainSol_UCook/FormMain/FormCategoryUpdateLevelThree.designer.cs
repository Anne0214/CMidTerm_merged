namespace FormMain
{
    partial class FormCategoryUpdateLevelThree
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "精選分類LEVEL_THREE_NAME名稱:";
			// 
			// button1
			// 
			...
			this.Name = "FormCategoryUpdateLevelThree";
			this.Text = "CATEGORY_食譜分類_LEVEL_THREE";
