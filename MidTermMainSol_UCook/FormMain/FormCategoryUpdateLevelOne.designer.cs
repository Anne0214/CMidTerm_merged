namespace FormMain
{
    partial class FormCategoryUpdateLevelOne
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "精選分類LEVEL_ONE_NAME名稱:";
			// 
			// button1
			// 
			...
			this.Name = "FormCategoryUpdateLevelOne";
			this.Text = "CATEGORY_食譜分類_LEVEL_ONE";
